...
import '../../apiChannels.dart';

Widget CartoonsContainer()
{
  return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text('Cartoons',style: TextStyle(
              fontSize: 26,
              letterSpacing: 2,
...
Future<List<DataModel>> fetchDataCartoons() async {
  String jsonData = await rootBundle.loadString('assets/cartoons.json');
